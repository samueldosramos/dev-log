...
- [Epic Spinners](http://epic-spinners.epicmax.co/#/)
- [iziModal](http://izimodal.marcelodolce.com/)
- [Nifty Modal Window Effects](https://tympanus.net/Development/ModalWindowEffects)
- [Notification Styles Inspiration](https://tympanus.net/Development/NotificationStyles/bar-slidetop.html)
...
- [Simple Sharing Buttons Generator](https://simplesharingbuttons.com/#intro)
...
- [Quanto custa a minha hora?](http://www.minhahora.entreoutros.com/)
- [Calculadora Freelancer](https://www.99freelas.com.br/apps/calculadora-freelancer)
...
- [#coffee is the color](http://c0ffee.surge.sh/)
- [Open color - Optimized for UI like font, background, border, etc.](https://yeun.github.io/open-color/)
...
- [Normalize - CSS resets](http://necolas.github.io/normalize.css/)
...
- [Thimble - Mozilla](https://thimble.mozilla.org/pt-BR/)
...
- [Font CombinationsLibrary](https://fontcomb.kkuistore.com)
...
- [Brazilian Font Icons](https://brazilianicons.github.io/brazilianicons/)
...
- [Foodeverest](http://www.foodeverest.com/)
- [FreeFOODPhotos](http://www.freefoodphotos.com/)
...
- [Lorem Ipsum](https://loremipsumgenerator.com/)
...
- [Designscrazed](https://dcrazed.com/free-responsive-html5-css3-templates/)
...
- [Material (responsividade)](https://material.io/resizer/)
- [Responsive View (responsividade)](http://responsiv.eu/)
- [Semalt (responsividade)](http://semalt.design/)
- [Viewlike (responsividade)](https://www.viewlike.us/)
- [Mobiletest (responsividade)](http://mobiletest.me/)
- [TestMySite Google (performance)](https://testmysite.thinkwithgoogle.com/intl/pt-br)
- [GTmetrix (velocidade)](https://gtmetrix.com/)
- [Pingdom (velocidade)](https://tools.pingdom.com/)
- [Varvy SEO tool](https://varvy.com/)
- [Lighthouse (qualidade)](https://developers.google.com/web/tools/lighthouse/)
- [Secur1ty (segurança)](https://secur1ty.com/grader)
- [Observatory (segurança)](https://observatory.mozilla.org/)
- [Ferramenta de SEO](https://neilpatel.com/br/seo-analyzer/)
- [WooRank (SEO)](https://www.woorank.com/pt)
- [Lind AB Test](https://netshoes.github.io/lind/)
