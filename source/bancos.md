...
- [Guia de Linguagem SQL](https://www.devmedia.com.br/guia/sql/38314)
...
[Guia rápido de comandos SQLite3](http://pythonclub.com.br/guia-rapido-comandos-sqlite3.html)
...
- [Introduction to Postgres](https://flaviocopes.com/postgres-introduction/)
- [6 motivos para usar o PostgreSQL em vez do MySQL](https://www.lucascaton.com.br/2018/01/31/6-motivos-para-usar-o-postgresql-em-vez-do-mysql/)
- [Resumo de comandos úteis do PostgreSQL](https://www.lucascaton.com.br/2010/05/23/resumo-de-comandos-uteis-do-postgresql/)
- [PostgreSQL como um banco de dados NoSQL](http://db4beginners.com/blog/postgresql-como-um-banco-de-dados-nosql/)
- [5 itens fofos sobre data types do PostgreSQL](http://db4beginners.com/blog/data-type-do-postgresql/)
- [A Microsoft comprou a Citusdata… Mas quem é o Citus?](http://db4beginners.com/blog/microsoft-comprou-citusdata-mas-quem-e-o-citus/)
...
- [Tutorial: O Pplware ensina a trabalhar com o MySQL (Parte I)](http://pplware.sapo.pt/tutoriais/tutorial-o-pplware-ensina-a-trabalhar-com-o-mysql-parte-i/)
- [Tutorial: O Pplware ensina a trabalhar com o MySQL (Parte II)](http://pplware.sapo.pt/tutoriais/tutorial-o-pplware-ensina-a-trabalhar-com-o-mysql-parte-ii/)
- [Tutorial: O Pplware ensina a trabalhar com o MySQL (Parte III)](http://pplware.sapo.pt/tutoriais/tutorial-o-pplware-ensina-a-trabalhar-com-o-mysql-parte-iii/)
